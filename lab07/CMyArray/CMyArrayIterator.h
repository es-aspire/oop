...
public:
	...
	using self_type = CMyArrayIterator<T>;
	...
	CMyArrayIterator operator+(difference_type offset) const;
...
template<typename T>
typename CMyArrayIterator<T>::self_type& CMyArrayIterator<T>::operator+=(difference_type offset)
{
